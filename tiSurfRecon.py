# Marching cubes, modified from the taichi official example of marching_squares
...
pixels = ti.field(float, (N, N, N))

# import the lookup tables into taichi field
edge_table = ti.field( int, [256,16])  # edge table 
